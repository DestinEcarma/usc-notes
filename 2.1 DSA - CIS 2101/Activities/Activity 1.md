...
Create a function to insert a new element at the end of a [[Linked List|linked list]]. The function should handle the case where the element does not yet exist.
